...
#define PLATFORM_VERSION    "OpenCL 2.0 (Oclgrind " PACKAGE_VERSION ")"
...
#define DEVICE_VERSION       "OpenCL 2.0 (Oclgrind " PACKAGE_VERSION ")"
#define DEVICE_LANG_VERSION  "OpenCL C 2.0 (Oclgrind " PACKAGE_VERSION ")"
